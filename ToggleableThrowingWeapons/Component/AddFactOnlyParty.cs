...
namespace ToggleableThrowingWeapons.Component
{
    public class AddFactOnlyParty : UnitFactComponentDelegate, IUnitLevelUpHandler
    {
        public override void OnActivate()
        {
            ...
            Main.TTWContext.Logger.Log($"Applying {Feature.NameSafe()} for {this.Owner} is IsPet={Owner.IsPet} IsMainCharacter={Owner.IsMainCharacter} IsCustomCompanion={Owner.IsCustomCompanion()} IsStoryCompanion={Owner.IsStoryCompanion()}");
